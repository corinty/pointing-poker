    ...
    return (
        <div>
            ...
            <div style={{ fontSize: '80%', fontWeight: 'lighter' }}>
                {copiedSuccessfully && <div style={{ paddingTop: '1em', paddingLeft: '1em' }}>Copied link to clipboard!</div>}
                {copiedUnsuccessfully && <div style={{ paddingTop: '1em', paddingLeft: '1em' }}>Failed to copy link to clipboard</div>}
            </div>
        </div>
    );
}
